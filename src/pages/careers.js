  ...
  <Layout>
    <section id="about" className="py-10 lg:pb-20 lg:pt-28">
      ...
      <div className="container mx-auto">
        ...
        <div class="container mx-auto px-12 mt-4 mb-4">
          <ul class="list-disc">
            ...
            <li><b>Work life boundaries - </b> we organize the company so that you can work clear, reasonable hours and then live your life. There are no expectations
              that you constantly check your email or Slack while you are not at work. No gimmicks like unlimited vacation: you know what vacation time you have
              and are free to take that time. We all work hard while at work and then enjoy the rest of our lives.</li>
        ...
        <div class="mt-4">
          <p>
            <p><b>Linux Developer / Developer in Test</b></p>
          </p>
          <p>
            Help build a Linux desktop secure virtualization product that will be deployed to tens of thousands of users. This is a unique oppurtunity to build
            a desktop-focused Linux product with a great tech stack: KVM, libvirt, rust, rpm-ostree. We are a small team of very experienced Linux developers
            looking to add another developer that will work on both development and test automation, including test as part of continous integration. Automating the testing
          ...
          <div class="container mx-auto px-12 mt-4 mb-4">
            <ul class="list-disc">
              ...
              automation will be both for the Linux desktop product itself and a range of connected infrastucture, which will include Linux, Windows, and networking infrastructure, so 
        ...
        <div class="mt-4">
          ...
          <div class="container mx-auto px-12 mt-4 mb-4">
            <ul class="list-disc">
              ...
              from scratch from developer documentation and descriptions, so this is an oppurtunity to do things right from the start, but it also means that you need to have a strong understanding
        ...
        <div class="mt-4">
          ...
          <p>
            If you are interested in SELinux, this is an oppurtunity to dive deep by working on systems that use SELinux to its full potential and work with one of the most experienced SELinux developers
