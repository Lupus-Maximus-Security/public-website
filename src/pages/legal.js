...
const Index = () => (
  <Layout>
    ...
    <section id="legal" className="container mx-auto ">
      <div className="py-10 lg:pb-20 lg:pt-28">
        <h1 className="text-2xl">Privacy Policy</h1>
        <p className="mb-4">Last updated: August 16, 2021</p>
        <p className="mb-4">
        ...
        <ul className="list-disc ml-4">
          ...
          <li>
            <p className="mb-4">
              ...
              this Agreement) refers to Big Bad Wolf Security LLC.
            </p>
          </li>
          <li>
            <p className="mb-4">
          ...
          <li>
            <p className="mb-4">
              <strong>Website</strong> refers to Big Bad Wolf Security, accessible from{' '}
              <a
                href="https://bigbadwolfsecurity.com"
                rel="external nofollow noopener"
                target="_blank"
              >
                https://bigbadwolfsecurity.com
              </a>
            </p>
          </li>
          <li>
        ...
        <h1 className="text-2xl">Collecting and Using Your Personal Data</h1>
        <h2 className="text-xl">Types of Data Collected</h2>
        ...
        <p className="mb-4">
          ...
          information may include, but is not limited to: Email address, Usage Data
        </p>
        ...
        <h3 className="text-lg">Tracking Technologies and Cookies</h3>
        <p className="mb-4">
        ...
        <h2 className="text-xl">Use of Your Personal Data</h2>
        ...
        <h2 className="text-xl">Retention of Your Personal Data</h2>
        <p className="mb-4">
        ...
        <h2 className="text-xl">Transfer of Your Personal Data</h2>
        <p className="mb-4">
        ...
        <h2 className="text-xl">Disclosure of Your Personal Data</h2>
        <h3 className="text-lg">Business Transactions</h3>
        <p className="mb-4">
        ...
        <h2 className="text-xl">Security of Your Personal Data</h2>
        <p className="mb-4">
        ...
        <ul className="list-disc ml-4">
          <li>By email: info@bigbadwolfsecurity.com</li>
        </ul>
      </div>
    </section>
  </Layout>
